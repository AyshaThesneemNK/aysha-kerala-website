...
const checkPhonenumber = () => {
  ...
  else if (!isPhonenumberValid(phonenumber<10)){
    showError(phonenumberEl, 'It must contain 10 digits without alphabets and special characters except . and - ');
  }
